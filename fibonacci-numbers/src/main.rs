...
pub fn calculate_fibonnacci(n:u64) -> u64
{
    if n <= 1
    {
        return 1
    ...
    {
        let fib = calculate_fibonnacci(n-1) + calculate_fibonnacci(n-2);
        return fib
    }
}
...
fn main()
{
    ...
    println!("The {} term is {}", term_in_series, calculate_fibonnacci(term_in_series));
}